...
@section('content')
    ...
    <div class="modal fade" id="modalDetallesUnicoUsuario" tabindex="-1" aria-labelledby="modalDetallesBienLabel" aria-hidden="true">
            ...
            <div class="modal-content border-0 shadow rounded-4">
                ...
                <div class="modal-body py-4 px-4">
                    <div class="row g-4 align-items-stretch">
                        ...
                        <!-- Columna izquierda - Información General y Técnica -->
                        <div class="col-md-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <span id="detalle-estado" class="badge rounded-pill px-3 py-2 bg-secondary">—</span>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="small text-muted">Disponibilidad</div>
                                                    <span id="detalle-status" class="badge rounded-pill px-3 py-2 bg-secondary">—</span>
                                                </div>
                                                <div class="col-12">
                        ...
                        <!-- Columna derecha - Información de Asignación y Documentación -->
                        <div class="col-md-6">
                            <div class="row g-4 h-100">
                                ...
                                <div class="col-12">
                                    <div class="card border-0 bg-light-subtle h-100">
                                        <div class="card-body">
                                            <h6 class="text-uppercase text-secondary fw-semibold mb-3">
                                                <i class="fas fa-handshake me-2"></i>Información de Asignación
                                            </h6>
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <span id="detalle-estado-asignacion" class="badge rounded-pill px-3 py-2 bg-secondary">—</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <div id="detalle-documento" class="fw-semibold mb-3">—</div>
                                                </div>
                                                <div class="col-12">
