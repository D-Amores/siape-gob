...
@section('content')
    <div class="card-body">
        <a href="login" class="text-nowrap logo-img text-center d-block mb-5 w-100">
            ...
            <img src="{{ asset('modernize/assets/images/logos/kanan.png') }}" class="dark-logo" width="250"
                alt="Logo-Dark" />

            <img src="{{ asset('modernize/assets/images/logos/kanan.png') }}" class="light-logo" width="250"
