...
@section('subtitle', 'Gestión de usuarios y registros pendientes')
...
@section('actions')
    ...
    <button class="btn btn-outline-primary w-md-auto me-2" id="btnAbrirCrearUsuario" data-bs-toggle="modal"
        data-bs-target="#crearPersonalModal">
        <i class="bx bx-plus me-1"></i>
        Registrar Personal
    </button>
@endsection
                ...
                <ul class="nav nav-tabs gap-2" id="adminTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link border-3 border-primary border-bottom-0 rounded-top-2 rounded-bottom-0"
                            id="pendientes-tab" data-bs-toggle="tab" data-bs-target="#pendientes" type="button"
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link border-3 border-primary border-bottom-0 rounded-top-2 rounded-bottom-0"
                            id="usuarios-tab" data-bs-toggle="tab" data-bs-target="#usuarios" type="button" role="tab"
...
<div class="modal fade" id="crearPersonalModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
